  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold uppercase">Sellers</h1>
      </div>
        ...
        <table className="w-full">
          ...
          <tbody>
            {sellers.map((seller, index) => (
              <tr key={seller.id} className="border-t border-t-gray-300">
                <td className="p-4 text-mid-grey">{index + 1}</td>
                <td className="p-4 font-medium text-mid-grey">
                  {seller.fullname}
                </td>
                <td className="p-4 text-mid-grey">{seller.email}</td>
                <td className="p-4 text-mid-grey">{seller.phone}</td>
                <td className="p-4 text-mid-grey capitalize">{seller.role}</td>
              </tr>
            ))}
          </tbody>
        </table>
