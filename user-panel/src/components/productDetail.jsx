    ...
    <>
      <div className="space-y-8 bg-white p-6 rounded-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-3 p-6 bg-white border border-gray-200 rounded-2xl">
            ...
            <div className="pb-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
                ...
                <div>
                  {product.stock > 0 ? (
                    <span className="text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-full py-1 px-3 inline-flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                      In Stock ({product.stock} available)
                    </span>
                  ) : (
                    <span className="text-xs font-bold text-red-700 bg-red-50 border border-red-200 rounded-full py-1 px-3 inline-flex items-center gap-1.5">
                      Out of Stock
                    </span>
                  )}
                </div>
            ...
            {((product.sizes && product.sizes.length > 0) ||
              ...
              <div className="space-y-3 pb-4">
                ...
                {colorsList.length > 0 && (
                  <div
                    className={`space-y-3 ${product.sizes && product.sizes.length > 0 ? "pt-4 border-t border-gray-100" : ""}`}
                  >
                    <h3 className="text-sm font-bold text-gray-800">
                      Select Color
                    </h3>
                      ...
                      {colorsList.map((col, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-4 py-2 rounded-xl text-xs font-bold transition border capitalize cursor-pointer ${
                              isSelected
